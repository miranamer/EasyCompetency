...
const SideBar = ({setCurrentPage}) => {
  return (
    <div className="h-full w-[200px] bg-green-400">
        ...
        <div className=" text-white text-xl flex flex-col mt-[20%]">
            ...
            <button onClick={() => setCurrentPage("APIPage")} className="m-5 text-center pr-3 font-semibold hover:underline">Add API Key</button>
        </div>
    </div>
  )
}
